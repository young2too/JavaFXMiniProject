...
public class SpaceInvaders extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		Timeline timeline = new Timeline(new KeyFrame(Duration.millis(100), e -> run(gc,gc2)));
	...
	//run Graphics
	private void run(GraphicsContext gc, GraphicsContext gc2) {
		
		gc2.setFill(Color.grayRgb(20));
		gc2.fillRect(10, 10, WIDTH, HEIGHT);
		gc2.setTextAlign(TextAlignment.CENTER);
		gc2.setFont(Font.font(20));
		gc2.setFill(Color.WHITE);
		gc2.fillText("일시정지 : SPACE" + 0,0,0);
